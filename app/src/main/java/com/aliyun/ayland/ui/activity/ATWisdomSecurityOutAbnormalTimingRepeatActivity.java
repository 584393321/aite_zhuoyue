...
public class ATWisdomSecurityOutAbnormalTimingRepeatActivity extends ATBaseActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        if ("7".equals(cron_week) || "每天".equals(cron_week)) {
            ...
            cbSun.setChecked(cron_week.contains("0"));
