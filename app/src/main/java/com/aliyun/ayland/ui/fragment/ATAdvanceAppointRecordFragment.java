...
import com.aliyun.ayland.ui.adapter.ATAdvanceAppointRecordRVAdapter;
...
public class ATAdvanceAppointRecordFragment extends ATBaseFragment implements ATMainContract.View {
    private ATMainPresenter mPresenter;
    private ATAdvanceAppointRecordRVAdapter mVisitorAppointRecordRVAdapter;
    ...
    private void findShareVisitorPage() {
        if (houseBean == null)
            return;
        ...
        mPresenter.request(ATConstants.Config.SERVER_URL_FINDSHAREVISITORPAGE, jsonObject);
    }

    private void init() {
        houseBean = gson.fromJson(ATGlobalApplication.getHouse(), ATHouseBean.class);
        mVisitorAppointRecordRVAdapter = new ATAdvanceAppointRecordRVAdapter(getActivity());
    ...
    public void requestResult(String result, String url) {
        try {
            ...
            if ("200".equals(jsonResult.getString("code"))) {
                if (ATConstants.Config.SERVER_URL_FINDSHAREVISITORPAGE.equals(url)) {
