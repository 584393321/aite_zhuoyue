...
public class ATLinkagePerformSceneRVAdapter extends RecyclerView.Adapter {
    private Activity mContext;
    private List<ATSceneBean> list = new ArrayList<>();

    public ATLinkagePerformSceneRVAdapter(Activity context) {
        mContext = context;
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.at_item_rv_linkage_perform_scene, parent, false);
    ...
    public void setList(List<ATSceneBean> list) {
        this.list.clear();
