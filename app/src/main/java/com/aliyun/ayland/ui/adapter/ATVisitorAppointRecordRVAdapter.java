...
public class ATVisitorAppointRecordRVAdapter extends RecyclerView.Adapter {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView mTvName, mTvPhone, mTvVisiteTime, mTvLeaveTime, mTvTripMode, mTvStartTime;
        ...
        public void setData(int position) {
            ...
            mTvStartTime.setText(String.format(mContext.getString(R.string.at_visit_time_2),
                    TextUtils.isEmpty(list.get(position).getActualStartTime()) ? "无" : list.get(position).getActualStartTime()));
            mTvLeaveTime.setText(String.format(mContext.getString(R.string.at_leave_time_),
                    TextUtils.isEmpty(list.get(position).getActualEndTime()) ? "无" : list.get(position).getActualEndTime()));
