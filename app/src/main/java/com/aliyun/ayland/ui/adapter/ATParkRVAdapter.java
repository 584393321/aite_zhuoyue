...
public class ATParkRVAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private List<ATDeviceAccessBean> list = new ArrayList<>();
    private int selectPosition = -1;

    public ATParkRVAdapter(Context context) {
        mContext = context;
    }
    ...
    public void setList(List<ATDeviceAccessBean> list, int selectPosition) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            mTvCarNumber.setText(list.get(position).getName());
