...
public class ATHomeShortcutFamilyRVAdapter extends RecyclerView.Adapter {
    private Activity mContext;
    private List<ATFamilyDeviceBean> list = new ArrayList<>();
    private RequestOptions options = new RequestOptions()
            .placeholder(R.drawable.common)
            .diskCacheStrategy(DiskCacheStrategy.ALL);

    public ATHomeShortcutFamilyRVAdapter(Activity context) {
        mContext = context;
    }
    ...
    public void setLists(List<ATFamilyDeviceBean> list) {
        this.list.clear();
    ...
    public class ShortcutViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(int position) {
            ...
            Glide.with(mContext).load(list.get(position).getMyImage()).apply(options).into(mImg);
