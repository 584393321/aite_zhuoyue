...
public class ATAutoUtils {
    ...
    public static void autoSize(View view) {
        ...
        if (lp.width > 0) {
            int screenWidth = ATAutoLayoutConifg.getInstance().getScreenWidth();
            int designWidth = ATAutoLayoutConifg.getInstance().getDesignWidth();
            lp.width = (int) (lp.width * 1.0f / designWidth * screenWidth);
        }

        if (lp.height > 0) {
            int screenHeight = ATAutoLayoutConifg.getInstance().getScreenWidth();
            int designHeight = ATAutoLayoutConifg.getInstance().getDesignWidth();
