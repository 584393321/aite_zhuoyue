...
public class ATAutoCollapsingToolbarLayout extends CollapsingToolbarLayout {
    private ATAutoLayoutHelper mHelper = new ATAutoLayoutHelper(this);

    public ATAutoCollapsingToolbarLayout(Context context) {
        super(context);
    }

    public ATAutoCollapsingToolbarLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ATAutoCollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new ATAutoCollapsingToolbarLayout.LayoutParams(getContext(), attrs);
    }
