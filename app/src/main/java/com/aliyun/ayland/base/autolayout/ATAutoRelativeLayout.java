...
public class ATAutoRelativeLayout extends RelativeLayout {
    private final ATAutoLayoutHelper mHelper = new ATAutoLayoutHelper(this);

    public ATAutoRelativeLayout(Context context) {
        super(context);
    }

    public ATAutoRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ATAutoRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
