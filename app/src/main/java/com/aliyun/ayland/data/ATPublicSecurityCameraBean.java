...
public class ATPublicSecurityCameraBean {
    /**
     * buildingCode : 10002
     * createPerson : 1000009
     * createTime : 2021-03-16T09:44:05
     * customerCode : 10008
     * deviceName : szty-cs-192.168.6.6
     * deviceType : 2
     * equipmentCode : 1000461
     * id : 83
     * ifDelete : false
     * iotId : CaF8fenIwip61d4dcdbp000000
     * ip : 192.168.6.6
     * isIot : true
     * name : 演示摄像头-1
     * password :
     * productKey : a1QFrcKYbay
     * rtspUrl :
     * userName :
     * videoCloudUrl :
     * villageCode : 10197
    ...
    public void setIsIot(boolean isIot) {
        this.isIot = isIot;
    }
    ...
    public String getVideoCloudUrl() {
        return videoCloudUrl;
    }

    public void setVideoCloudUrl(String videoCloudUrl) {
        this.videoCloudUrl = videoCloudUrl;
    }
