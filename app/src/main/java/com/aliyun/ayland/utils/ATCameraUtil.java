...
import com.aliyun.ayland.ui.activity.ATCameraActivity;
...
public class ATCameraUtil {
    ...
    private static ATCameraUtil myCamPara = null;

    private ATCameraUtil() {

    }

    public static ATCameraUtil getInstance() {
        if (myCamPara == null) {
            myCamPara = new ATCameraUtil();
            return myCamPara;
        } else {
            return myCamPara;
        }
    ...
    public void startCamera(Activity activity,int requestCode) {
        Intent intent = new Intent(activity, ATCameraActivity.class);
