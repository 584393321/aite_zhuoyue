 ...
 * 这个类提供一些操作Bitmap的方法
 */
public final class ATBitmapUtils {
    /**
     * Log TAG
     */
    ...
    public static Bitmap createBitmap(Context context, byte[] data, float orientation) {
        ...
        try {
            ...
            opts.inSampleSize =
                    com.baidu.idl.face.platform.utils.BitmapUtils.computeSampleSize(opts, min, com.baidu.idl.face.platform.utils.BitmapUtils.MAXLENTH * com.baidu.idl.face.platform.utils.BitmapUtils.MAXLENTH);
            opts.inJustDecodeBounds = false;
            bitmap = BitmapFactory.decodeByteArray(data, 0, data.length, opts);
            transformed = com.baidu.idl.face.platform.utils.BitmapUtils.rotateBitmap(orientation, bitmap);
            ...
            BitmapFactory.decodeByteArray(data, 0, data.length, opts);
            opts.inSampleSize =
                    com.baidu.idl.face.platform.utils.BitmapUtils.computeSampleSize(opts, -1, opts.outWidth * opts.outHeight
                            / com.baidu.idl.face.platform.utils.BitmapUtils.PIC_COMPRESS_SIZE);
            opts.inJustDecodeBounds = false;
            bitmap = BitmapFactory.decodeByteArray(data, 0, data.length, opts);
            transformed = com.baidu.idl.face.platform.utils.BitmapUtils.rotateBitmap(orientation, bitmap);
        }
    ...
    public static int computeSampleSize(BitmapFactory.Options options, int minSideLength, int maxNumOfPixels) {
        int initialSize = com.baidu.idl.face.platform.utils.BitmapUtils.computeInitialSampleSize(options, minSideLength, maxNumOfPixels);
        int roundedSize;
    ...
    public static int computeInitialSampleSize(BitmapFactory.Options options, int minSideLength,
        ...
        int upperBound =
                (minSideLength == -1) ? com.baidu.idl.face.platform.utils.BitmapUtils.IMAGEBOUND : (int) Math.min(
    ...
    public static Bitmap createBitmap(Context context, String filename, int orientatoin) {
        ...
        try {
            ...
            transformed = com.baidu.idl.face.platform.utils.BitmapUtils.rotateBitmap(orientatoin, bitmap);
        } catch (OutOfMemoryError e) {
            e.printStackTrace();
            if (bitmap != null) {
                bitmap.recycle();
...
//            }
        ...
        opts.inSampleSize =
                com.baidu.idl.face.platform.utils.BitmapUtils.computeSampleSize(opts, -1, opts.outWidth * opts.outHeight
                        / com.baidu.idl.face.platform.utils.BitmapUtils.PIC_COMPRESS_SIZE);
        Log.e("createBitmap: ", opts.outWidth + "----" + opts.outHeight);
        opts.inJustDecodeBounds = false;
    ...
    public static Bitmap createLivenessBitmap(Context context, int[] argbByte, Rect roundRect) {
        ...
        try {
            transformed = Bitmap.createBitmap(argbByte,
                    roundRect.width(), roundRect.width() / 3 * 4,
