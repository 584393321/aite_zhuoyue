package com.aliyun.ayland.blur;
 ...
 */
public class ATBlurDialogEngine {

    /**
     * Log cat
     */
    private static final String TAG = ATBlurDialogEngine.class.getSimpleName();
     ...
     */
    public ATBlurDialogEngine(Activity holdingActivity) {
     ...
     * {@link ATBlurDialogEngine#BLUR_DOWN_SCALE_FACTOR}
     * <p/>
     ...
     * {@link ATBlurDialogEngine#BLUR_RADIUS}
     *
    ...
    private void blur(Bitmap bkg, View view) {
        ...
        try{
        	...
        	Log.d("gateway", "BlurDialogEngine Canvas: trying to use a recycled bitmap");
        }
     
        //apply fast blur on overlay
        overlay = ATFastBlurHelper.doBlur(overlay, mBlurRadius, false);
