 ...
 */
public class ATSupportBlurDialogFragment extends DialogFragment {
     ...
     * Engine used to blur.
     */
    private ATBlurDialogEngine mBlurEngine;
     ...
     */
    public ATSupportBlurDialogFragment() {
        mDebugEnable = false;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBlurEngine = new ATBlurDialogEngine(getActivity());
