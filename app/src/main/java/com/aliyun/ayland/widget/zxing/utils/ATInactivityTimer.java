 ...
 * power.
 */
public class ATInactivityTimer {

	private static final String TAG = ATInactivityTimer.class.getSimpleName();
	...
	public ATInactivityTimer(Activity activity) {
	...
	private class PowerStatusReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			if (Intent.ACTION_BATTERY_CHANGED.equals(intent.getAction())) {
				...
				if (onBatteryNow) {
					ATInactivityTimer.this.onActivity();
				} else {
					ATInactivityTimer.this.cancel();
				}
			}
		}
	}
