 ...
 * hei hei hei
 */
public class ATSwitchView extends View {
    ...
    public ATSwitchView(Context context) {
        this(context, null);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public ATSwitchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setLayerType(LAYER_TYPE_SOFTWARE, null);

        final int DEFAULT_COLOR_PRIMARY = 0xFF1478C8;
        final int DEFAULT_COLOR_PRIMARY_DARK = 0xFF1478C8;

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ATSwitchView);
        colorPrimary = a.getColor(R.styleable.ATSwitchView_primaryColor, DEFAULT_COLOR_PRIMARY);
        colorPrimaryDark = a.getColor(R.styleable.ATSwitchView_primaryColorDark, DEFAULT_COLOR_PRIMARY_DARK);
        colorOff = a.getColor(R.styleable.ATSwitchView_offColor, 0xFFE3E3E3);
        colorOffDark = a.getColor(R.styleable.ATSwitchView_offColorDark, 0xFFBFBFBF);
        colorShadow = a.getColor(R.styleable.ATSwitchView_shadowColor, 0xFF333333);
        ratioAspect = a.getFloat(R.styleable.ATSwitchView_ratioAspect, 0.68f);
        hasShadow = a.getBoolean(R.styleable.ATSwitchView_hasShadow, true);
        isOpened = a.getBoolean(R.styleable.ATSwitchView_isOpened, false);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // draw bar
        canvas.scale(0.8f, 0.8f, bWidth / 2, bWidth / 2);
        paint.setStyle(Paint.Style.FILL);
        paint.setColor(0xffffffff);
        canvas.drawPath(bPath, paint);
    ...
    public interface OnStateChangedListener {
        void toggleToOn(ATSwitchView view);

        void toggleToOff(ATSwitchView view);
    }
