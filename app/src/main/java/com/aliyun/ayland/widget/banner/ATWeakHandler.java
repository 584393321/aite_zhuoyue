...
public class ATWeakHandler {
     ...
     */
    public ATWeakHandler(@Nullable Handler.Callback callback) {
     ...
     */
    public ATWeakHandler(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public ATWeakHandler(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
