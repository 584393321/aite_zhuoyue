 ...
 */
public class ATMagicIndicator extends FrameLayout {
    private ATIPagerNavigator mNavigator;

    public ATMagicIndicator(Context context) {
        super(context);
    }

    public ATMagicIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public ATIPagerNavigator getNavigator() {
        return mNavigator;
    }

    public void setNavigator(ATIPagerNavigator navigator) {
