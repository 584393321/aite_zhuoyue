 ...
 */
public class ATOptionsPickerView<T> extends ATBasePickerView implements View.OnClickListener {

    private ATWheelOptions wheelOptions;

    private static final String TAG_SUBMIT = "submit";
    private static final String TAG_CANCEL = "cancel";


    public ATOptionsPickerView(ATPickerOptions pickerOptions) {
    ...
    private void initView(Context context) {
        ...
        wheelOptions = new ATWheelOptions(optionsPicker, mPickerOptions.isRestoreItem);
