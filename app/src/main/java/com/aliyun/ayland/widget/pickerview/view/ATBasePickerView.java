...
import com.aliyun.ayland.widget.pickerview.utils.ATPickerViewAnimateUtil;
...
public class ATBasePickerView {
    ...
    protected ATPickerOptions mPickerOptions;
    private ATOnDismissListener onDismissListener;
    ...
    public ATBasePickerView(Context context) {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.at_layout_basepickerview, null, false);
            //设置界面的背景为透明
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.at_layout_basepickerview, mPickerOptions.decorView, false);
        ...
        mPickerOptions.decorView.post(new Runnable() {
            ...
            public void run() {
                ...
                if (onDismissListener != null) {
                    onDismissListener.onDismiss(ATBasePickerView.this);
                }
            }
        });
    ...
    private Animation getInAnimation() {
        int res = ATPickerViewAnimateUtil.getAnimationResource(this.animGravity, true);
        return AnimationUtils.loadAnimation(context, res);
    }

    private Animation getOutAnimation() {
        int res = ATPickerViewAnimateUtil.getAnimationResource(this.animGravity, false);
        return AnimationUtils.loadAnimation(context, res);
    }

    public ATBasePickerView setOnDismissListener(ATOnDismissListener onDismissListener) {
    ...
    protected ATBasePickerView setOutSideCancelable(boolean isCancelable) {
