package com.aliyun.ayland.widget.pickerview.configure;
...
public class ATPickerOptions {
    ...
    public ATOnOptionsSelectListener optionsSelectListener;
    public ATOnTimeSelectListener timeSelectListener;
    public View.OnClickListener cancelListener;

    public ATOnTimeSelectChangeListener timeSelectChangeListener;
    public ATOnOptionsSelectChangeListener optionsSelectChangeListener;
    public ATCustomListener customListener;
    ...
    public ATPickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.at_pickerview_options;
        } else {
            layoutRes = R.layout.at_pickerview_time;
        }
    }
    ...
    public ATWheelView.DividerType dividerType = ATWheelView.DividerType.FILL;//分隔线类型
