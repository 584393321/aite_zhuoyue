 ...
 */
public class ATClipPagerTitleView extends View implements ATIMeasurablePagerTitleView {
    ...
    public ATClipPagerTitleView(Context context) {
        super(context);
        init(context);
    }

    private void init(Context context) {
        int textSize = ATUIUtil.dip2px(context, 16);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setTextSize(textSize);
        int padding = ATUIUtil.dip2px(context, 10);
