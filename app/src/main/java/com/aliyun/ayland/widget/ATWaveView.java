...
public class ATWaveView extends View {
    /**
     * +------------------------+
     * |<--wave length->        |______
     * |   /\          |   /\   |  |
    ...
    public ATWaveView(Context context) {
        super(context);
        init();
    }

    public ATWaveView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ATWaveView(Context context, AttributeSet attrs, int defStyle) {
