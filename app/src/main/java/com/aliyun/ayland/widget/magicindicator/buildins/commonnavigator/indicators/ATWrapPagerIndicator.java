 ...
 */
public class ATWrapPagerIndicator extends View implements ATIPagerIndicator {
    ...
    public ATWrapPagerIndicator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mVerticalPadding = ATUIUtil.dip2px(context, 6);
        mHorizontalPadding = ATUIUtil.dip2px(context, 10);
    }
