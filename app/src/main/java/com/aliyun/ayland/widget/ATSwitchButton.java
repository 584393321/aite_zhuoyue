...
import com.aliyun.ayland.utils.ATColorUtils;
...
public class ATSwitchButton extends CompoundButton {
    ...
    public ATSwitchButton(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public ATSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public ATSwitchButton(Context context) {
        super(context);
        init(null);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, R.styleable.ATSwitchButton);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(R.styleable.ATSwitchButton_kswThumbDrawable);
            thumbColor = ta.getColorStateList(R.styleable.ATSwitchButton_kswThumbColor);
            margin = ta.getDimension(R.styleable.ATSwitchButton_kswThumbMargin, margin);
            marginLeft = ta.getDimension(R.styleable.ATSwitchButton_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(R.styleable.ATSwitchButton_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(R.styleable.ATSwitchButton_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(R.styleable.ATSwitchButton_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(R.styleable.ATSwitchButton_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(R.styleable.ATSwitchButton_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(R.styleable.ATSwitchButton_kswThumbRadius, thumbRadius);
            backRadius = ta.getDimension(R.styleable.ATSwitchButton_kswBackRadius, backRadius);
            backDrawable = ta.getDrawable(R.styleable.ATSwitchButton_kswBackDrawable);
            backColor = ta.getColorStateList(R.styleable.ATSwitchButton_kswBackColor);
            thumbRangeRatio = ta.getFloat(R.styleable.ATSwitchButton_kswThumbRangeRatio, thumbRangeRatio);
            animationDuration = ta.getInteger(R.styleable.ATSwitchButton_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(R.styleable.ATSwitchButton_kswFadeBack, true);
            tintColor = ta.getColor(R.styleable.ATSwitchButton_kswTintColor, tintColor);
            textOn = ta.getString(R.styleable.ATSwitchButton_kswTextOn);
            textOff = ta.getString(R.styleable.ATSwitchButton_kswTextOff);
            textThumbInset = ta.getDimensionPixelSize(R.styleable.ATSwitchButton_kswTextThumbInset, 0);
            textExtra = ta.getDimensionPixelSize(R.styleable.ATSwitchButton_kswTextExtra, 0);
            textAdjust = ta.getDimensionPixelSize(R.styleable.ATSwitchButton_kswTextAdjust, 0);
            ta.recycle();
        }
        ...
        if (!mIsThumbUseDrawable && mThumbColor == null) {
            mThumbColor = ATColorUtils.generateThumbColorWithTintColor(mTintColor);
        ...
        if (!mIsBackUseDrawable && mBackColor == null) {
            mBackColor = ATColorUtils.generateBackColorWithTintColor(mTintColor);
