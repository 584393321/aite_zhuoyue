...
public class ATArcShapeView extends View {
    ...
    public ATArcShapeView(Context context) {
        this(context, null);
    }

    public ATArcShapeView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ATArcShapeView(Context context, AttributeSet attrs, int defStyleAttr) {
