 ...
 */
public class ATTriangularPagerIndicator extends View implements ATIPagerIndicator {
    ...
    public ATTriangularPagerIndicator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mTriangleWidth = ATUIUtil.dip2px(context, 14);
        mTriangleHeight = ATUIUtil.dip2px(context, 8);
    }
