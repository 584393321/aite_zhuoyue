 ...
 */
public class ATBezierPagerIndicator extends View implements ATIPagerIndicator {
    ...
    public ATBezierPagerIndicator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mMaxCircleRadius = ATUIUtil.dip2px(context, 3.5);
        mMinCircleRadius = ATUIUtil.dip2px(context, 2);
        mYOffset = ATUIUtil.dip2px(context, 1.5);
    }
