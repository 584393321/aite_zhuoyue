...
public class ATGymTimePopup extends ATBasePopupWindow {
    private Activity context;
    private ATOptionsPickerView pvOptions;
    private ATWheelView mWheelCompareType;

    public ATGymTimePopup(Activity context) {
        super(context);
    ...
    private void init() {
        ...
        findViewById(R.id.tv_sure).setOnClickListener(view -> {
            EventBus.getDefault().post(new ATEventInteger("ConvenientShareGYMActivity2", mWheelCompareType.getCurrentItem()));
            dismiss();
        });
