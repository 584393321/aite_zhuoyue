...
public class ATWheelOptions<T> {
    private View view;
    private ATWheelView wv_option1;
    private ATWheelView wv_option2;
    private ATWheelView wv_option3;
    ...
    private ATOnItemSelectedListener wheelListener_option1;
    private ATOnItemSelectedListener wheelListener_option2;

    private ATOnOptionsSelectChangeListener optionsSelectChangeListener;
    ...
    public ATWheelOptions(View view, boolean isRestoreItem) {
        super();
        this.isRestoreItem = isRestoreItem;
        this.view = view;
        wv_option1 = (ATWheelView) view.findViewById(R.id.options1);// 初始化时显示的数据
        wv_option2 = (ATWheelView) view.findViewById(R.id.options2);
        wv_option3 = (ATWheelView) view.findViewById(R.id.options3);
    }
    ...
    public void setPicker(List<T> options1Items,
        ...
        // 选项1
        wv_option1.setAdapter(new ATArrayWheelAdapter(mOptions1Items));// 设置显示数据
        wv_option1.setCurrentItem(0);// 初始化时显示的数据
        // 选项2
        if (mOptions2Items != null) {
            wv_option2.setAdapter(new ATArrayWheelAdapter(mOptions2Items.get(0)));// 设置显示数据
        }
        wv_option2.setCurrentItem(wv_option2.getCurrentItem());// 初始化时显示的数据
        // 选项3
        if (mOptions3Items != null) {
            wv_option3.setAdapter(new ATArrayWheelAdapter(mOptions3Items.get(0).get(0)));// 设置显示数据
        }
        ...
        // 联动监听器
        wheelListener_option1 = new ATOnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if (mOptions2Items == null) {//只有1级联动数据
                    ...
                    wv_option2.setAdapter(new ATArrayWheelAdapter(mOptions2Items.get(index)));
        ...
        wheelListener_option2 = new ATOnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                if (mOptions3Items != null) {
                    ...
                    wv_option3.setAdapter(new ATArrayWheelAdapter(mOptions3Items.get(wv_option1.getCurrentItem()).get(index)));
        ...
        if (options3Items != null && linkage && optionsSelectChangeListener != null) {
            wv_option3.setOnItemSelectedListener(new ATOnItemSelectedListener() {
                @Override
                public void onItemSelected(int index) {
    ...
    public void setNPicker(List<T> options1Items, List<T> options2Items, List<T> options3Items) {
        ...
        // 选项1
        wv_option1.setAdapter(new ATArrayWheelAdapter(options1Items));// 设置显示数据
        wv_option1.setCurrentItem(0);// 初始化时显示的数据
        // 选项2
        if (options2Items != null) {
            wv_option2.setAdapter(new ATArrayWheelAdapter(options2Items));// 设置显示数据
        }
        wv_option2.setCurrentItem(wv_option2.getCurrentItem());// 初始化时显示的数据
        // 选项3
        if (options3Items != null) {
            wv_option3.setAdapter(new ATArrayWheelAdapter(options3Items));// 设置显示数据
        }
        wv_option3.setCurrentItem(wv_option3.getCurrentItem());
        wv_option1.setIsOptions(true);
        wv_option2.setIsOptions(true);
        ...
        if (optionsSelectChangeListener != null) {
            wv_option1.setOnItemSelectedListener(new ATOnItemSelectedListener() {
                @Override
                public void onItemSelected(int index) {
        ...
        if (options2Items == null) {
            ...
            wv_option2.setVisibility(View.VISIBLE);
            if (optionsSelectChangeListener != null) {
                wv_option2.setOnItemSelectedListener(new ATOnItemSelectedListener() {
                    @Override
                    public void onItemSelected(int index) {
    ...
    private void itemSelected(int opt1Select, int opt2Select, int opt3Select) {
        ...
        if (mOptions2Items != null) {
            wv_option2.setAdapter(new ATArrayWheelAdapter(mOptions2Items.get(opt1Select)));
            wv_option2.setCurrentItem(opt2Select);
        }
        if (mOptions3Items != null) {
            wv_option3.setAdapter(new ATArrayWheelAdapter(mOptions3Items.get(opt1Select).get(opt2Select)));
    ...
    public void setOptionsSelectChangeListener(ATOnOptionsSelectChangeListener optionsSelectChangeListener) {
