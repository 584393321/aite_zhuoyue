package com.aliyun.ayland.widget.magicindicator.buildins.circlenavigator;
 ...
 */
public class ATCircleNavigator extends View implements ATIPagerNavigator {
    private int mRadius;
    ...
    public ATCircleNavigator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mRadius = ATUIUtil.dip2px(context, 3);
        mCircleSpacing = ATUIUtil.dip2px(context, 8);
        mStrokeWidth = ATUIUtil.dip2px(context, 1);
    }
