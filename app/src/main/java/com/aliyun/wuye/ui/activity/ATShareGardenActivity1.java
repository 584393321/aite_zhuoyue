...
public class ATShareGardenActivity1 extends ATBaseActivity implements ATMainContract.View {
    ...
    private Dialog dialog, phoneDialog;
    ...
    private List<ATOwnerNameBean> mATOwnerNameBean;
...
//        }
        ...
        jsonObject.put("sharedSpaceCode", mATShareSpaceAppList.get(app_position).getId());
        jsonObject.put("personCode", mATOwnerNameBean.get(0).getPersonCode());
    ...
    private void init() {
        ATSystemStatusBarUtils.init(ATShareGardenActivity1.this, false);
