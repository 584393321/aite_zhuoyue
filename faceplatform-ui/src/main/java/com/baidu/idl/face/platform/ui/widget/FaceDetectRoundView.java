...
public class FaceDetectRoundView extends View {
    ...
    public static final float SURFACE_RATIO = 1f;
    ...
    public static final int COLOR_BG = Color.TRANSPARENT;
    public static final int COLOR_RECT = Color.parseColor("#FFFFFF");
    public static final int COLOR_ROUND = Color.parseColor("#1478C8");
